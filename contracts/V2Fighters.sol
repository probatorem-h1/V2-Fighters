    ...
    ReentrancyGuard
{
    ...
    function getInfo() external view override returns (Info memory) {
        ...
        allInfo.whitelistCost = whiteCost;
        allInfo.maxSupply = maxTokens;
        allInfo.totalSupply = totalSupply();
        allInfo.maxMintPerAddress = nftPerAddressLimit;
        allInfo.maxMintPerTx = maxMintAmount;
